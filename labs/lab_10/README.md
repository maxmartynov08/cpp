...
## Задание
Вам требуется реализовать консольное приложение `./lab_10`, которое
...
В этом задании вам придется реализовать два не очень удачных архитектурных решения. В задании это допустимо и даже необходимо, но в будущем постарайтесь этих паттерном избегать:
...
## Сроки сдачи
Задание выдано 18.03.2021 (четверг).
Первый срок сдачи — 24.03.2021 (среда) 22:59 по Москве.
Крайний срок сдачи — **26.03.2021 (суббота) 22:59 по Москве**.
